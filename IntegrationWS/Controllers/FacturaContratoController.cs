...
{
    public class FacturaContratoController : ApiController
    {
        //[HttpPost]
        //[Authorize]
        //public IHttpActionResult Post([FromBody] ServiceContratDTO caseDTO)
        //{
        //    try
        //    {
        ...
        //        {
        //            respuesta = db_bnrd.Database.SqlQuery<string>($"EXEC VerficicarExistenciaFactura 1, '{caseDTO.ServiceContratNumber}'").FirstOrDefault();

        //            if (string.IsNullOrEmpty(respuesta))
        //            {
        //                respuesta = db_bnrd.Database.SqlQuery<string>($"EXEC VerficicarExistenciaFactura 3, '{caseDTO.ServiceContratNumber}'").FirstOrDefault();
        //            }
        //        }
        ...
        //            salespersonKey.Id = "00086"; //<-- Colocando a Hector como vendedor fijo --Debo de cambiarlo
        ...
        //            var comentario = caseDTO.Comentarios;

        //            CommentKey commentKey = new CommentKey();
        //            commentKey.Id = caseDTO.ServiceContratNumber;
